...
The optimal number of boosting itterations are around 35, its hard to tell exactly with such messy ticks at the x-axis. The gray lines represent the different trees that are weighted together as the black line. 
...
Above the code for the two different estimations, the Ada-tree has the family specified as AdaExp. 
...
A gif for the mu parameters can be found here. 
